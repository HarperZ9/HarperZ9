...
REQUIRED_README_TERMS = (
    ...
    "You want me when the work is too important to leave as vibes",
    "What you are buying is not \"AI fluency.\"",
    ...
    "A repo nobody can explain",
    "A prototype people like but cannot trust.",
    "Buy the pattern.",
    "Buy me when the job is not",
    "Do not buy me for a quiet maintenance lane",
