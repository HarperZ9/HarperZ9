...
Badge walls, visitor counters, typing SVGs, generic GitHub stats cards,
off-brand custom diagrams, busy dark dashboards, and claims that are not backed
by a public link or test path.
...
Use descriptive alt text, real text for all key claims, public links, no motion,
and a static hero image that is not required to understand the profile.
