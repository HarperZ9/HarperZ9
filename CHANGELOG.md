...
- Reworked the profile README to match the live Project Telos site language:
  eight engines, clean professional positioning, and explicit tester paths.
- Replaced the custom profile diagram with the canonical Project Telos
  flagship card artwork.
- Added `PRODUCT.md` so future profile edits preserve the brand purpose,
...
- Added a profile-surface verification script and GitHub Actions CI.
- Added standalone usage documentation for public and developer visitors.

## Current Status

- Runtime: GitHub profile README repository.
- Surfaces: public profile README, authorship note, usage guide, product brief,
  and linked Project Telos repos/pages.
- Verification: local profile-surface script and public surface sweep.
